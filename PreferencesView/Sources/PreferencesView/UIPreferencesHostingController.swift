...
public class UIPreferencesHostingController: UIHostingController<AnyView> {
    ...
    override public func viewDidDisappear(_ animated: Bool) {
        ...
        onDidDisappearAfterDismiss?()
        onDidDisappearAfterDismiss = nil
    }
    ...
    public static var globalSupportedOrientationsOverride: UIInterfaceOrientationMask?
    public static var globalPreferredInterfaceOrientationOverride: UIInterfaceOrientation?

    public var supportedOrientationsOverride: UIInterfaceOrientationMask? {
        didSet {
            setNeedsUpdateOfSupportedInterfaceOrientations()
        }
    }

    public var preferredInterfaceOrientationOverride: UIInterfaceOrientation? {
        didSet {
            setNeedsUpdateOfSupportedInterfaceOrientations()
        }
    }
    ...
    override public var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        Self.globalSupportedOrientationsOverride ?? supportedOrientationsOverride ?? _orientations
    }

    override public var preferredInterfaceOrientationForPresentation: UIInterfaceOrientation {
        Self.globalPreferredInterfaceOrientationOverride ??
            preferredInterfaceOrientationOverride ??
