...
extension AddTaskTriggerView {
    ...
    struct TriggerTypeRow: View {
        ...
        @Binding
        var taskTriggerInfo: EmbyTaskTrigger
        ...
        var body: some View {
            Picker(
                ...
                ForEach(EmbyTaskTriggerType.allCases, id: \.self) { type in
                    Text(type.displayTitle)
                        .tag(type as EmbyTaskTriggerType?)
                }
            }
        ...
        private func resetValuesForNewType(newType: EmbyTaskTriggerType?) {
