...
struct DevicesView: View {
    ...
    var body: some View {
        ...
        .alert(L10n.deleteDeviceFailed, isPresented: $isPresentingSelfDeleteError) {
            ...
            Text(L10n.deleteDeviceSelfDeletion(viewModel.userSession.embyClient.configuration.identity.deviceName))
        }
    ...
    private var contentView: some View {
        List {
            InsetGroupedListHeader(
                ...
                UIApplication.shared.open(.embyDocsDevices)
            }
    ...
    private var deleteDeviceConfirmationActions: some View {
        ...
        Button(L10n.delete, role: .destructive) {
            if let deviceToDelete = selectedDevices.first, selectedDevices.count == 1 {
                if deviceToDelete == viewModel.userSession.embyClient.configuration.identity.deviceID {
