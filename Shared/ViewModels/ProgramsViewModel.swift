...
final class ProgramsViewModel: ViewModel, Stateful {
    ...
    private func getRecommendedPrograms() async throws -> [BaseItemDto] {
        ...
        var parameters = EmbyPortRecommendedProgramsParameters()
        parameters.fields = .MinimumFields
            .appending(.channelInfo)
        parameters.isAiring = true
        parameters.limit = 20

        let response: EmbyPortItemsResponse<BaseItemDto> = try await userSession.embyClient.recommendedPrograms(
            parameters,
