        ...
        var body: some View {
            VStack(alignment: .leading, spacing: 24) {
                ...
                if let episodeViewModel = viewModel as? EpisodeItemViewModel,
                   let seriesViewModel = episodeViewModel.seriesViewModel,
                   seriesViewModel.seasons.isNotEmpty
                {
                    SeriesEpisodeSelector(viewModel: seriesViewModel, focusItem: episodeViewModel.item)
                }
