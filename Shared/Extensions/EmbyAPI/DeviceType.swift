...
enum DeviceType: String, Displayable, Codable, CaseIterable {
    ...
    init(client: String?, deviceName: String?) {
        ...
        /* Apple devices: iOS, tvOS, iPadOS, Emby, or Infuse */
        case let str where str.range(of: #"ios|tvos|ipados|emby|infuse"#, options: .regularExpression) != nil:
            self = .apple
        ...
        /* Emby Web or EmbyWeb */
        case let str where str.range(of: #"emby.web|embyweb"#, options: .regularExpression) != nil:
    ...
    // MARK: - Initialize the Browser if Emby Web
