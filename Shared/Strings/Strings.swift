...
internal enum L10n {
  ...
  /// Additional security access for users signed in to this device. This does not change any Emby server user settings.
  internal static let additionalSecurityAccessDescription = L10n.tr("Localizable", "additionalSecurityAccessDescription", fallback: "Additional security access for users signed in to this device. This does not change any Emby server user settings.")
  /// Add server
  ...
  /// Connect to an Emby server to get started
  internal static let connectToEmbyServerStart = L10n.tr("Localizable", "connectToEmbyServerStart", fallback: "Connect to an Emby server to get started")
  /// Connect to server
  ...
  /// The custom device profiles will be added to the default Emby device profiles.
  internal static let customDeviceProfileAdd = L10n.tr("Localizable", "customDeviceProfileAdd", fallback: "The custom device profiles will be added to the default Emby device profiles.")
  /// The custom device profiles will replace the default Emby device profiles.
  internal static let customDeviceProfileReplace = L10n.tr("Localizable", "customDeviceProfileReplace", fallback: "The custom device profiles will replace the default Emby device profiles.")
  ...
  /// Perform administrative tasks for your Emby server.
  internal static let dashboardDescription = L10n.tr("Localizable", "dashboardDescription", fallback: "Perform administrative tasks for your Emby server.")
  /// Date
  ...
  /// Downloaded items are only playable through the Emby video player.
  internal static let downloadedPlayerWarning = L10n.tr("Localizable", "downloadedPlayerWarning", fallback: "Downloaded items are only playable through the Emby video player.")
  /// Downloads
  ...
  /// This item exists on your Emby Server.
  internal static let existsOnServer = L10n.tr("Localizable", "existsOnServer", fallback: "This item exists on your Emby Server.")
  /// Experimental
  ...
  /// Access the Emby server logs for troubleshooting and monitoring purposes.
  internal static let logsDescription = L10n.tr("Localizable", "logsDescription", fallback: "Access the Emby server logs for troubleshooting and monitoring purposes.")
  /// Long press
  ...
  /// Metadata is refreshed based on settings and internet services that are enabled in Emby.
  internal static let metadataRefreshDescription = L10n.tr("Localizable", "metadataRefreshDescription", fallback: "Metadata is refreshed based on settings and internet services that are enabled in Emby.")
  /// Method
  ...
  /// Changes the Emby server user password. This does not change any Emby settings.
  internal static let passwordChangeWarning = L10n.tr("Localizable", "passwordChangeWarning", fallback: "Changes the Emby server user password. This does not change any Emby settings.")
  ...
  /// Uses libmpv to provide compatibility with nearly any file type. However, libmpv cannot use HomePod or AirPlay-enabled speakers, HDR, Picture in Picture, or AirPlay casting.
  internal static let playerEmbyDescription = L10n.tr("Localizable", "playerEmbyDescription", fallback: "Uses libmpv to provide compatibility with nearly any file type. However, libmpv cannot use HomePod or AirPlay-enabled speakers, HDR, Picture in Picture, or AirPlay casting.")
  /// Play From beginning
  ...
  /// Reset Emby user settings.
  internal static let resetSettingsDescription = L10n.tr("Localizable", "resetSettingsDescription", fallback: "Reset Emby user settings.")
  ...
  /// Emby requires Emby version %@ or higher.
  internal static func serverVersionWarning(_ p1: Any) -> String {
    return L10n.tr("Localizable", "serverVersionWarning", String(describing: p1), fallback: "Emby requires Emby version %@ or higher.")
  }
  /// Session
  ...
  /// Signs out the last user when Emby has been in the background without media playback after some time.
  internal static let signoutBackgroundFooter = L10n.tr("Localizable", "signoutBackgroundFooter", fallback: "Signs out the last user when Emby has been in the background without media playback after some time.")
  /// Sign out on close
  internal static let signoutClose = L10n.tr("Localizable", "signoutClose", fallback: "Sign out on close")
  /// Signs out the last user when Emby has been force closed.
  internal static let signoutCloseFooter = L10n.tr("Localizable", "signoutCloseFooter", fallback: "Signs out the last user when Emby has been force closed.")
  /// Size
  ...
  /// Unable to perform device authentication. You may need to enable Face ID in the Settings app for Emby.
  internal static let unableToPerformDeviceAuthFaceID = L10n.tr("Localizable", "unableToPerformDeviceAuthFaceID", fallback: "Unable to perform device authentication. You may need to enable Face ID in the Settings app for Emby.")
  /// Unaired
  ...
  /// This will be created as a new item on your Emby Server.
  internal static let willBeCreatedOnServer = L10n.tr("Localizable", "willBeCreatedOnServer", fallback: "This will be created as a new item on your Emby Server.")
