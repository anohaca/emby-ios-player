...
class Fastfile: LaneFile {
    ...
    private let embyBundleIdentifier = "org.emby.iosplayer"
    private let embyXcodeProject = "Emby.xcodeproj"
    ...
    func testFlightLane(withOptions options: [String: String]?) {
        ...
        if let providedVersion = options["version"]?.trimOption() {
            ...
            appStoreBuildNumber(
                ...
                appIdentifier: embyBundleIdentifier,
        ...
        if let build = options["build"]?.trimOption() {
            incrementBuildNumber(
                ...
                xcodeproj: .userDefined(embyXcodeProject)
            )
        } else {
