...
class ItemEditorViewModel<Element: Equatable>: ViewModel {
    ...
    private func _delete() async throws {
        ...
        try await userSession.embyClient.deleteItem(itemID: itemID)
    ...
    private func _refreshMetadata(
        ...
        try await userSession.embyClient.refreshItem(
            itemID: itemId,
            metadataRefreshMode: metadataRefreshMode,
    ...
    func updateItem(_ newItem: BaseItemDto) async throws {
        ...
        try await userSession.embyClient.updateItem(itemID: itemId, body: updateItem)
