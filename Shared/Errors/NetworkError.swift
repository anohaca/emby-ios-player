...
//    case EmbyError(response: ErrorResponse, displayMessage: String?)
//
...
//        case let .EmbyError(response, displayMessage):
//            return NetworkError.parseEmbyError(from: response, displayMessage: displayMessage)
//        }
//    }
//
...
//    }
//
//    private static func parseEmbyError(from response: ErrorResponse, displayMessage: String?) -> ErrorMessage {
//        let errorMessage: ErrorMessage
//
//        switch response {
